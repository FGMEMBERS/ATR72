...
var electrical = {
       init : func {
			...
			atr_suppliers = [supplier.new("eng1-gen", "DC", 28, 400, 1, "/engines/engine/thruster/prop_rpm", 1400, 350, "/controls/elec_panel/gen1"), supplier.new("eng2-gen", "DC", 28, 400, 1, "/engines/engine[1]/thruster/prop_rpm", 1400, 350, "/controls/elec_panel/gen2"), supplier.new("ext-pwr", "DC", 28, 600, 0, "", 0, 0, "/controls/elec_panel/ext-pwr"), supplier.new("batt-main", "DC", 24, 43, 0, "", 0, 0, "/controls/elec_panel/batt-main"), supplier.new("batt-emer", "DC", 24, 15, 0, "", 0, 0, "/controls/elec_panel/batt-emer")];
			
			atr_buses = [bus.new("dc-bus1", "DC", ["eng1-gen"]), bus.new("dc-bus2", "DC", ["eng2-gen"]), bus.new("hot-main-bat-bus", "DC", ["batt-main"]), bus.new("hot-emer-bat-bus", "DC", ["batt-emer"])]; # 2 AC Generators also exist but are not being used currently, I'll probably put them in later.
			
			atr_outputs = [output.new("avionics", 12, 1, ["dc-bus1", "dc-bus2", "hot-main-bat-bus", "hot-emer-bat-bus"]), output.new("comm", 12, 1, ["dc-bus1", "dc-bus2", "hot-main-bat-bus", "hot-emer-bat-bus"]), output.new("fuel-pump1", 28, 20, ["dc-bus1"]), output.new("fuel-pump2", 28, 20, ["dc-bus2"]), output.new("anti-icing", 24, 2, ["dc-bus1", "dc-bus2", "hot-main-bat-bus"]), output.new("lights", 24, 12, ["dc-bus1", "dc-bus2", "hot-main-bat-bus", "util-bus-cont"]), output.new("nav", 16, 2, ["dc-bus1", "dc-bus2", "hot-main-bat-bus", "hot-emer-bat-bus"]), output.new("pneu", 24, 12, ["dc-bus1", "hot-main-bat-bus", "hot-emer-bat-bus"]), output.new("hydraulic-blue", 24, 12, ["dc-bus1"]), output.new("hydraulic-aux", 24, 8, ["dc-bus1"]), output.new("hydraulic-green", 24, 12, ["dc-bus2", "hot-main-bat-bus", "hot-main-emer-bus"])];
